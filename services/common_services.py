...
class DocumentStatus(str, Enum):
    ...
    COMPLETED_CHUNKING = "COMPLETED_CHUNKING"
...
class StorageService:
    ...
    def __init__(self, bucket_name: str, endpoint_url: Optional[str] = None):
        ...
        # For demo, use local filesystem - use relative path that works cross-platform
        self.local_root = Path(__file__).parent.parent / "s3_storage"
